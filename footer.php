        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 footer-list text-center">
                    ...
                    <p> © <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. All Rights Reserved.<br>本站已萌萌哒(✪ω✪)运行<span id="span_dt_dt">Loading...</span><br>Theme <a href="#" target="_blank" rel="nofollow">Kratos</a> Made by <a href="https://www.fczbl.vip" target="_blank" rel="nofollow">moedog</a> Modified by <a href="#" target="_blank" rel="nofollow">XiaoQin</a><?php if(kratos_option('sitemap')) echo ' <br><a href="'.get_option('home').'/sitemap.html" target="_blank">Sitemap</a>'; ?>
                        <?php if(kratos_option('icp_num')) echo '<br><a href="http://beian.bizcn.com/" rel="external nofollow" target="_blank">'.kratos_option('icp_num').'</a>';
